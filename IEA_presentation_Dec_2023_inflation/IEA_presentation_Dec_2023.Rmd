...
### Peristenct ideas don't pan out
...
-   Robust to several measures of time-length and comparsion points.
...
(Though inflation in this rate might be better than a 2 percent target.)
...
- Let's make a basket of the most demand sensitive categories.

-   Take 179 individual CPI spending category inflation rates since 2000.

- Put each under an aggressive accelerationist Phillips Curve: 

$$\pi_{i,t} = \pi_{i,t-1} + \beta(u - u^*)$$

- Only select items where $\beta$ has a t-statistic less than -2.

- 16 categories, including housing, day care, motor vehicle repair, restaurants, funeral expenses, and wine at home.

- Excluding housing, demand-sensitive basket is 9 percent of consumption.
