...
[^1]: Mike Konczal is the Director of the Roosevelt Institute's Macroeconomic Analysis team. Special thanks to Sonya Gurwitt for editorial support and Adam Shapiro for comments. Replication code can be found [here](https://github.com/mtkonczal/Prices-Profits-and-Power-Replication-Code).
